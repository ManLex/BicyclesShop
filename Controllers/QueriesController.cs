...
namespace Lab2DBBicycles.Controllers
{
    public class QueriesController : Controller
    {
        ...
        {
            string queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SimpleOne.sql");
            queryText = queryText.Replace("StoreA", query.StoreName1);
            queryText = queryText.Replace("StoreB", query.StoreName2);

            query.Id = 1;

            using (var connection = new SqlConnection("Server= DESKTOP-F4O4TB5; Database=Lab2DB; Trusted_Connection=True; MultipleActiveResultSets=true"))
            {
                connection.Open();
        ...
        {
            string queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SimpleTwo.sql");
        ...
        {
            string queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SimpleThree.sql");
        ...
        {
            string queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SimpleFour.sql");
            queryText = queryText.Replace("StoreA", query.StoreName1);
            ...
            queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SimpleFour_Helper.sql");
            queryText = queryText.Replace("StoreA", query.StoreName1);
        ...
        {
            string queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SimpleFive.sql");
            queryText = queryText.Replace("StoreA", query.StoreName1);
        ...
        {
            string queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SetOne.sql");
        ...
        {
            string queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SetTwo.sql");
        ...
        {
            string queryText = System.IO.File.ReadAllText(@"D:\Program\Proga\Lab2DBBicycles-master\Lab2DBBicycles\Queries\SetThree.sql");
